...
`;
  ...
  const modelApiIdentifier$9 = "user";
  const pluralModelApiIdentifier$9 = "users";
  const operations$9 = [
    {
      type: "findOne",
    ...
    },
    {
      ...
      modelSelectionField: modelApiIdentifier$9,
      isBulk: false,
      isDeleter: false,
      variables: {
    ...
    },
    {
      ...
      modelApiIdentifier: modelApiIdentifier$9,
      modelSelectionField: pluralModelApiIdentifier$9,
      namespace: null,
  ...
  const modelApiIdentifier$8 = "conversation";
  const pluralModelApiIdentifier$8 = "conversations";
  const operations$8 = [
    {
      type: "findOne",
    ...
    },
    {
      ...
      modelApiIdentifier: modelApiIdentifier$8,
      operatesWithRecordIdentity: false,
      modelSelectionField: modelApiIdentifier$8,
      isBulk: false,
      isDeleter: false,
      variables: {
    ...
    },
    {
      ...
      modelApiIdentifier: modelApiIdentifier$8,
      modelSelectionField: pluralModelApiIdentifier$8,
      namespace: null,
      variables: {
  ...
  const modelApiIdentifier$7 = "message";
  const pluralModelApiIdentifier$7 = "messages";
  const operations$7 = [
    {
      type: "findOne",
  ...
  const modelApiIdentifier$6 = "session";
  const pluralModelApiIdentifier$6 = "sessions";
  const operations$6 = [
    {
      type: "findOne",
  ...
  const modelApiIdentifier$5 = "session";
  const pluralModelApiIdentifier$5 = "sessions";
  const operations$5 = [
    {
      type: "get",
            ...
            207(__unused_webpack_module, __webpack_exports__2, __webpack_require__2) {
              ...
              class ScriptReceiverFactory {
                ...
                create(callback) {
                  ...
                  return { number, id: id2, name: name2, callback: callbackWrapper };
                }
                remove(receiver) {
              ...
              var cb_utob = function(c2) {
                ...
                return cc2 < 128 ? c2 : cc2 < 2048 ? fromCharCode(192 | cc2 >>> 6) + fromCharCode(128 | cc2 & 63) : fromCharCode(224 | cc2 >>> 12 & 15) + fromCharCode(128 | cc2 >>> 6 & 63) + fromCharCode(128 | cc2 & 63);
              };
              ...
              function encodeParamsObject(data) {
                return mapObject(data, function(value2) {
                  if (typeof value2 === "object") {
              ...
              function buildQueryString(data) {
                var params = filterObject(data, function(value2) {
              ...
              class TransportConnection extends Dispatcher {
                constructor(hooks2, name2, priority, key2, options) {
                  super();
              ...
              class Transport {
                ...
                createConnection(name2, priority, key2, options) {
                  return new TransportConnection(this.hooks, name2, priority, key2, options);
                }
              }
              ...
              class Connection extends Dispatcher {
                ...
                handleCloseEvent(closeEvent) {
                  ...
                  var error2 = protocol.getCloseError(closeEvent);
                  if (error2) {
                    this.emit("error", error2);
                  }
                  if (action) {
              ...
              var base642 = __webpack_require__2(594);
              class EncryptedChannel extends PrivateChannel {
                constructor(name2, pusher3, nacl) {
                  super(name2, pusher3);
                  this.key = null;
                  this.nacl = nacl;
                }
                authorize(socketId, callback) {
                  super.authorize(socketId, (error2, authData) => {
                    ...
                    this.key = (0, base642.decode)(sharedSecret);
                ...
                handleEncryptedEvent(event, data) {
                  ...
                  let cipherText = (0, base642.decode)(data.ciphertext);
                  if (cipherText.length < this.nacl.secretbox.overheadLength) {
                    logger.error(`Expected encrypted event ciphertext length to be ${this.nacl.secretbox.overheadLength}, got: ${cipherText.length}`);
                    return;
                  }
                  let nonce = (0, base642.decode)(data.nonce);
              ...
              class Channels {
                ...
                add(name2, pusher3) {
                  if (!this.channels[name2]) {
                    this.channels[name2] = createChannel(name2, pusher3);
                  }
              ...
              function createChannel(name2, pusher3) {
                if (name2.indexOf("private-encrypted-") === 0) {
                  if (pusher3.config.nacl) {
                    return factory.createEncryptedChannel(name2, pusher3, pusher3.config.nacl);
                  }
                  let errMsg = "Tried to subscribe to a private-encrypted- channel but no nacl implementation available";
                  let suffix = url_store.buildLogSuffix("encryptedChannelSupport");
                  throw new UnsupportedFeature(`${errMsg}. ${suffix}`);
                } else if (name2.indexOf("private-") === 0) {
                  return factory.createPrivateChannel(name2, pusher3);
                } else if (name2.indexOf("presence-") === 0) {
                  return factory.createPresenceChannel(name2, pusher3);
                } else if (name2.indexOf("#") === 0) {
                  throw new BadChannelName('Cannot create a channel with name "' + name2 + '".');
                } else {
                  return factory.createChannel(name2, pusher3);
                }
              }
              var Factory = {
                createChannels() {
                ...
                createConnectionManager(key2, options) {
                  return new ConnectionManager(key2, options);
                },
                createChannel(name2, pusher3) {
                  return new Channel(name2, pusher3);
                },
                createPrivateChannel(name2, pusher3) {
                  return new PrivateChannel(name2, pusher3);
                },
                createPresenceChannel(name2, pusher3) {
                  return new PresenceChannel(name2, pusher3);
                },
                createEncryptedChannel(name2, pusher3, nacl) {
                  return new EncryptedChannel(name2, pusher3, nacl);
                },
              ...
              function connect(strategies, minPriority, callbackBuilder) {
                var runners = map2(strategies, function(strategy, i2, _, rs) {
              ...
              class WebSocketPrioritizedCachedStrategy {
                ...
                connect(minPriority, callback) {
                  ...
                  var runner = strategies.pop().connect(minPriority, function cb2(error2, handshake) {
                    if (error2) {
                      flushTransportCache(usingTLS);
                      if (strategies.length > 0) {
                        startTimestamp = util.now();
                        runner = strategies.pop().connect(minPriority, cb2);
                      } else {
                        callback(error2);
                      }
                    } else {
              ...
              var getDefaultStrategy = function(config2, baseOptions, defineTransport2) {
                ...
                function defineTransportStrategy(name2, type2, priority, options, manager) {
                  var transport = defineTransport2(config2, name2, type2, priority, options, manager);
              ...
              var defineTransport = function(config2, name2, type2, priority, options, manager) {
                ...
                if (enabled) {
                  ...
                  transport = new TransportStrategy(name2, priority, manager ? manager.getAssistant(transportClass) : transportClass, options);
                } else {
              ...
              function getConfig2(opts, pusher3) {
                let config2 = {
              ...
              class Pusher2 {
                static ready() {
                  ...
                  for (var i2 = 0, l2 = Pusher2.instances.length; i2 < l2; i2++) {
                ...
                constructor(app_key, options) {
                  ...
                  this.key = app_key;
                  this.options = options;
                  this.config = getConfig2(this.options, this);
          ...
          (() => {
            __webpack_require__.d = (exports$12, definition) => {
              for (var key2 in definition) {
                if (__webpack_require__.o(definition, key2) && !__webpack_require__.o(exports$12, key2)) {
                  Object.defineProperty(exports$12, key2, { enumerable: true, get: definition[key2] });
                }
              }
            };
          })();
