...
const findOneOperation = (operation, id, defaultSelection, modelApiIdentifier, options, namespace) => {
  ...
  let fields = {
    [operation]: (0, import_tiny_graphql_query_compiler.Call)(variables, fieldSelectionToQueryCompilerFields((options == null ? void 0 : options.select) || defaultSelection, true))
  };
