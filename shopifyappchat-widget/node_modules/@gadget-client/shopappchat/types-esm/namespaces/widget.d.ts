...
/** The widget namespace */ export declare class WidgetNamespace {
    readonly clientOrParent: {
        connection: GadgetConnection;
    };
    /** Executes the disconnect global action. */ disconnect: {
        (variables?: {
    ...
    /** Executes the pusherAuth global action. */ pusherAuth: {
        (variables?: {
