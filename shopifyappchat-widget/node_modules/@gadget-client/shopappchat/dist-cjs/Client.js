...
var import_widget = require("./namespaces/widget.js");
...
class ShopappchatClient {
  constructor(options) {
    ...
    /** Executes the trackEventQueue global action. */
    this.trackEventQueue = (0, import_builder.buildGlobalAction)(this, {
      type: "globalAction",
    ...
    /** Executes the trackEventsTHREE global action. */
    this.trackEventsTHREE = (0, import_builder.buildGlobalAction)(this, {
      type: "globalAction",
    ...
    */
    ...
    this.widget = new import_widget.WidgetNamespace(this);
    this.internal = {
