...
__export(Client_exports, {
  Client: () => Client,
  DefaultAnalyticsFIVESelection: () => import_AnalyticsFIVE2.DefaultAnalyticsFIVESelection,
  DefaultConversationSelection: () => import_Conversation2.DefaultConversationSelection,
  DefaultCustomerSelection: () => import_Customer2.DefaultCustomerSelection,
  DefaultMessageSelection: () => import_Message2.DefaultMessageSelection,
  DefaultOrganizationSelection: () => import_Organization2.DefaultOrganizationSelection,
  DefaultSessionSelection: () => import_Session2.DefaultSessionSelection,
  DefaultShopSelection: () => import_Shop2.DefaultShopSelection,
  DefaultTestModelSelection: () => import_TestModel2.DefaultTestModelSelection,
  DefaultUserSelection: () => import_User2.DefaultUserSelection,
  ShopappchatClient: () => ShopappchatClient,
...
var import_Conversation = require("./models/Conversation.js");
var import_Message = require("./models/Message.js");
var import_Organization = require("./models/Organization.js");
var import_Customer = require("./models/Customer.js");
var import_TestModel = require("./models/TestModel.js");
var import_AnalyticsFIVE = require("./models/AnalyticsFIVE.js");
var import_Shop = require("./models/Shop.js");
var import_Session2 = require("./models/Session.js");
var import_User2 = require("./models/User.js");
var import_Conversation2 = require("./models/Conversation.js");
var import_Message2 = require("./models/Message.js");
var import_Organization2 = require("./models/Organization.js");
var import_Customer2 = require("./models/Customer.js");
var import_TestModel2 = require("./models/TestModel.js");
var import_AnalyticsFIVE2 = require("./models/AnalyticsFIVE.js");
var import_Shop2 = require("./models/Shop.js");
const import_meta = {};
;
...
class ShopappchatClient {
  constructor(options) {
    ...
    /** Executes the getWidgetMessages global action. */
    this.getWidgetMessages = (0, import_builder.buildGlobalAction)(this, {
      type: "globalAction",
    ...
    /** Executes the initWidgetTwo global action. */
    this.initWidgetTwo = (0, import_builder.buildGlobalAction)(this, {
      type: "globalAction",
    ...
    /** Executes the logEvent global action. */
    this.logEvent = (0, import_builder.buildGlobalAction)(this, {
      type: "globalAction",
    ...
    /** Executes the markConversationRead global action. */
    this.markConversationRead = (0, import_builder.buildGlobalAction)(this, {
      type: "globalAction",
    ...
    /** Executes the markEmailRead global action. */
    this.markEmailRead = (0, import_builder.buildGlobalAction)(this, {
      type: "globalAction",
    ...
    /** Executes the sendHeartbeat global action. */
    this.sendHeartbeat = (0, import_builder.buildGlobalAction)(this, {
      type: "globalAction",
    ...
    /** Executes the sendMessageEmail global action. */
    this.sendMessageEmail = (0, import_builder.buildGlobalAction)(this, {
      type: "globalAction",
    ...
    /** Executes the sendWidgetMessage global action. */
    this.sendWidgetMessage = (0, import_builder.buildGlobalAction)(this, {
      type: "globalAction",
    ...
    /** Executes the shopifyPartnerApi global action. */
    this.shopifyPartnerApi = (0, import_builder.buildGlobalAction)(this, {
      type: "globalAction",
    ...
    /** Executes the testParams global action. */
    this.testParams = (0, import_builder.buildGlobalAction)(this, {
      type: "globalAction",
    ...
    /** Executes the trackEvent global action. */
    this.trackEvent = (0, import_builder.buildGlobalAction)(this, {
      type: "globalAction",
    ...
    /** Executes the trackEvents global action. */
    this.trackEvents = (0, import_builder.buildGlobalAction)(this, {
      type: "globalAction",
    ...
    /** Executes the trackEventsTWO global action. */
    this.trackEventsTWO = (0, import_builder.buildGlobalAction)(this, {
      type: "globalAction",
    ...
    */
    ...
    this.conversation = new import_Conversation.ConversationManager(this.connection);
    this.message = new import_Message.MessageManager(this.connection);
    this.organization = new import_Organization.OrganizationManager(this.connection);
    this.customer = new import_Customer.CustomerManager(this.connection);
    this.testModel = new import_TestModel.TestModelManager(this.connection);
    this.analyticsFIVE = new import_AnalyticsFIVE.AnalyticsFIVEManager(this.connection);
    this.shop = new import_Shop.ShopManager(this.connection);
    this.internal = {
      ...
      conversation: new import_InternalModelManager.InternalModelManager("conversation", this.connection, { "pluralApiIdentifier": "conversations", "hasAmbiguousIdentifiers": false, "namespace": [] }),
      message: new import_InternalModelManager.InternalModelManager("message", this.connection, { "pluralApiIdentifier": "messages", "hasAmbiguousIdentifiers": false, "namespace": [] }),
      organization: new import_InternalModelManager.InternalModelManager("organization", this.connection, { "pluralApiIdentifier": "organizations", "hasAmbiguousIdentifiers": false, "namespace": [] }),
      customer: new import_InternalModelManager.InternalModelManager("customer", this.connection, { "pluralApiIdentifier": "customers", "hasAmbiguousIdentifiers": false, "namespace": [] }),
      testModel: new import_InternalModelManager.InternalModelManager("testModel", this.connection, { "pluralApiIdentifier": "testModels", "hasAmbiguousIdentifiers": false, "namespace": [] }),
      analyticsFIVE: new import_InternalModelManager.InternalModelManager("analyticsFIVE", this.connection, { "pluralApiIdentifier": "analyticsFIVEs", "hasAmbiguousIdentifiers": false, "namespace": [] }),
      shop: new import_InternalModelManager.InternalModelManager("shop", this.connection, { "pluralApiIdentifier": "shops", "hasAmbiguousIdentifiers": false, "namespace": [] })
    };
  }
  /**
...
ShopappchatClient.prototype[import_core.$coreImplementation] = coreImplementation;
