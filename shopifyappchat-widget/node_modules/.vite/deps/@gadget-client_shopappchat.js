...
// node_modules/@gadgetinc/core/dist/esm/AnyClient.js
var $modelRelationships = Symbol.for("gadget/modelRelationships");
var $coreImplementation = Symbol.for("gadget/coreImplementation");

// node_modules/@gadgetinc/core/dist/esm/GadgetRecord.js
var ChangeTracking;
...
// node_modules/@gadgetinc/core/dist/esm/types.js
var $args = Symbol.for("gadget/fieldArgs");

// node_modules/@gadget-client/shopappchat/dist-esm/connection/ClientOptions.js
var AuthenticationMode = ((AuthenticationMode2) => {
...
var BrowserSessionStorageType = ((BrowserSessionStorageType2) => {
...
var extract = (e3, r2, t3) => {
  if (null == t3 || "object" != typeof t3 || t3.toJSON || i2.has(t3)) {
    ...
    for (var a2 = 0, n2 = t3.length; a2 < n2; a2++) {
      extract(e3, `${r2}.${a2}`, t3[a2]);
    }
  } else if (t3 instanceof d2 || t3 instanceof l) {
    e3.set(r2, t3);
  } else {
    i2.add(t3);
    for (var o2 in t3) {
      extract(e3, `${r2}.${o2}`, t3[o2]);
    }
  }
};
...
var stringifyDocument = (e3) => {
  ...
  if ("string" == typeof e3) {
    ...
    t3 = u2.get(e3) || sanitizeDocument(print(e3));
    u2.set(e3, t3);
  }
...
var deepMerge = (e3, r2) => {
  if ("object" == typeof e3 && null != e3) {
    if (Array.isArray(e3)) {
      e3 = [...e3];
      for (var t3 = 0, a2 = r2.length; t3 < a2; t3++) {
    ...
    var _loop = function() {
      ...
      if (e4.items) {
        ...
        for (var h2 = 0, y2 = e4.items.length; h2 < y2; h2++) {
          t4[p2 + h2] = deepMerge(t4[p2 + h2], e4.items[h2]);
        }
  ...
  if (a2.headers) {
    if (((e4) => "has" in e4 && !Object.keys(e4).length)(a2.headers)) {
      ...
      for (var n2 in a2.headers) {
        t3[n2.toLowerCase()] = a2.headers[n2];
      }
    }
  }
  var o2 = serializeBody(e3, r2);
  if ("string" == typeof o2 && !t3["content-type"]) {
...
async function* streamToBoundedChunks(e3, r2) {
  var t3 = "undefined" != typeof TextDecoder ? new TextDecoder() : null;
  var a2 = "";
  var n2;
  for await (var o2 of e3) {
    a2 += "Buffer" === o2.constructor.name ? o2.toString() : t3.decode(o2, {
      stream: true
    });
...
async function* fetchOperation(e3, r2, t3) {
  ...
  try {
    ...
    var s = (o2 = await (e3.context.fetch || fetch)(r2, t3)).headers.get("Content-Type") || "";
    var i3;
    if (/multipart\/mixed/i.test(s)) {
      ...
      i3 = async function* parseEventStream(e4) {
        var r3;
        for await (var t4 of streamToBoundedChunks(streamBody(e4), "\n\n")) {
          var a3 = t4.match(y);
          if (a3) {
            var n3 = a3[1];
            try {
...
var C = function Client(e3) {
  ...
  var makeResultSource = (e4) => {
    ...
    if ("query" !== e4.kind) {
      ...
      r3 = switchMap((r4) => {
        var t4 = fromValue(r4);
        return r4.stale || r4.hasNext ? t4 : merge([t4, map(() => {
          r4.stale = true;
          return r4;
...
function createClient(options) {
  ...
  function subscribe3(payload, sink) {
  ...
  return {
    ...
    iterate(request) {
      ...
      const dispose = subscribe3(request, {
        next(val) {
          pending.push(val);
          deferred.resolve();
        },
...
var printDocASTReducer = {
  ...
  StringValue: {
    leave: ({ value: value2, block: isBlockString }) => isBlockString ? printBlockString2(value2) : printString2(value2)
  },
  BooleanValue: {
...
function FragmentsOnCompositeTypesRule(context) {
  return {
    ...
    FragmentDefinition(node) {
      ...
      if (type2 && !isCompositeType(type2)) {
        const typeStr = print2(node.typeCondition);
        context.reportError(
          new GraphQLError2(
  ...
  return {
    ...
    NullValue(node) {
      ...
      if (isNonNullType(type2)) {
        context.reportError(
          new GraphQLError2(
            `Expected value of type "${inspect(type2)}", found ${print2(node)}.`,
            {
              nodes: node
            }
          )
...
function isValidValueNode(context, node) {
  ...
  if (!isLeafType(type2)) {
    ...
    context.reportError(
      new GraphQLError2(
        `Expected value of type "${typeStr}", found ${print2(node)}.`,
        {
          nodes: node
        }
      )
  ...
  try {
    ...
    if (error2 instanceof GraphQLError2) {
      ...
      context.reportError(
        new GraphQLError2(
          `Expected value of type "${typeStr}", found ${print2(node)}; ` + error2.message,
          {
            nodes: node,
  ...
  return {
    VariableDefinition(node) {
      ...
      if (type2 !== void 0 && !isInputType(type2)) {
        ...
        const typeName = print2(node.type);
        context.reportError(
          new GraphQLError2(
...
var QueryDocumentKeysToValidate = mapValue(
  QueryDocumentKeys,
  (keys) => keys.filter((key2) => key2 !== "description")
);
...
// node_modules/@gadget-client/shopappchat/dist-esm/connection/DataHydrator.js
var Hydrators = {
  DateTime(value2) {
...
// node_modules/@gadget-client/shopappchat/dist-esm/connection/GadgetRecord.js
...
var GadgetRecord = Object.assign(GadgetRecord_, {
  ChangeTracking
});

// node_modules/@gadget-client/shopappchat/dist-esm/connection/support.js
...
var InvalidRecordError = class extends Error {
  constructor(message, validationErrors, modelApiIdentifier8, record) {
    ...
    super(
      message ?? `GGT_INVALID_RECORD: ${modelApiIdentifier8 ?? "Record"} is invalid and can't be saved. ${firstErrors.map(({ apiIdentifier, message: message2 }) => `${apiIdentifier} ${message2}`).join(", ")}${extraErrorMessage}.`
    );
...
var GadgetValidationError = InvalidRecordError;
...
var isCloseEvent = (event) => (event == null ? void 0 : event.type) == "close";
...
var searchableFieldTypeName = (modelApiIdentifier8, namespace) => `${namespacedGraphQLTypeName(modelApiIdentifier8, namespace)}SearchFields`;
var getNonUniqueDataError = (modelApiIdentifier8, fieldName, fieldValue) => new GadgetNonUniqueDataError(
  `More than one record found for ${modelApiIdentifier8}.${fieldName} = ${fieldValue}. Please confirm your unique validation is not reporting an error.`
);
var getNonNullableError = (response, dataPath) => {
...
var hydrateRecordArray = (response, records) => {
  const hydrator = getHydrator(response);
  if (hydrator) {
    records = hydrator.apply(records);
  }
  return records == null ? void 0 : records.map((record) => new GadgetRecord(record));
};
...
var formatErrorMessages = (error2) => {
  const result = /* @__PURE__ */ new Map();
  if ("validationErrors" in error2) {
    const invalidRecordError = error2;
    ...
    const codeToReplace = "code" in error2 ? `${error2.code}: ` : "";
    const message = error2.message.replace(codeToReplace, "");
    result.set("root", { message });
  }
  return mapToObject(result);
};
var jsSearchFieldsToGqlSearchFields = (searchFields) => {
  const result = {};
  for (const [field, config] of Object.entries(searchFields)) {
    ...
    if (isPlainObject(config)) {
      ...
      if (hasScalarProperties) {
        const fieldConfig = {};
        for (const [key2, value2] of Object.entries(config)) {
...
var processBulkActionResponse = (defaultSelection, response, records, modelSelectionField, hasReturnType) => {
...
// node_modules/@gadget-client/shopappchat/dist-esm/connection/utils.js
...
// node_modules/@gadget-client/shopappchat/dist-esm/connection/operationBuilders.js
var $args2 = Symbol.for("gadget/fieldArgs");
var selectionValueToBuilderValue = (value2) => {
  if (typeof value2 !== "object" || value2 === null) {
    return value2;
  }
  const fieldArgs = value2[$args2];
...
var findOneOperation = (operation, id, defaultSelection, modelApiIdentifier8, options, namespace) => {
  ...
  let fields = {
    [operation]: Call(variables, fieldSelectionToQueryCompilerFields((options == null ? void 0 : options.select) || defaultSelection, true))
  };
  ...
  return compileWithVariableValues({
    ...
    fields: {
      ...fields,
      ...hydrationSelection(modelApiIdentifier8, namespace)
    },
    ...
    [operation]: Call(
      {
        ...
        sort: (options == null ? void 0 : options.sort) ? Var({ value: options.sort, type: `[${sortTypeName(modelApiIdentifier8, namespace)}!]` }) : void 0,
        filter: (options == null ? void 0 : options.filter) ? Var({ value: options.filter, type: `[${filterTypeName(modelApiIdentifier8, namespace)}!]` }) : void 0,
        ...
        searchFields: (options == null ? void 0 : options.searchFields) ? Var({
          ...
          type: `${searchableFieldTypeName(modelApiIdentifier8, namespace)}`
        }) : void 0
      },
      {
        ...
        edges: {
          cursor: true,
          node: fieldSelectionToQueryCompilerFields((options == null ? void 0 : options.select) || defaultSelection, true)
        }
      }
    )
  };
...
var actionOperation = (operation, defaultSelection, modelApiIdentifier8, modelSelectionField, variables, options, namespace, isBulkAction, hasReturnType) => {
  const selection = (options == null ? void 0 : options.select) || defaultSelection;
  let fields = {
    [operation]: Call(
...
var backgroundActionResultOperation = (id, action, options) => {
  ...
  switch (backgroundAction.type) {
    case "action": {
      const selection = (options == null ? void 0 : options.select) || backgroundAction.defaultSelection;
      fields = {
...
var getBackgroundActionStatusOperation = (id) => {
...
// node_modules/@gadget-client/shopappchat/dist-esm/connection/BackgroundActionHandle.js
...
var getBackgroundActionStatusRunner = async (connection, id) => {
...
// node_modules/@gadget-client/shopappchat/dist-esm/connection/ErrorWrapper.js
var ErrorWrapper = class _ErrorWrapper extends Error {
  constructor({
    networkError,
    executionErrors,
    response
  }) {
    const normalizedExecutionErrors = (executionErrors || []).map(rehydrateGraphQlError2);
  ...
  static errorIfDataAbsent(result, dataPath, paused = false) {
    ...
    let error2 = _ErrorWrapper.forMaybeCombinedError(result.error);
    if (!error2 && nonNullableError && !paused) {
      error2 = _ErrorWrapper.forClientSideError(nonNullableError);
    }
    return error2;
  }
...
var rehydrateGraphQlError2 = (error2) => {
...
// node_modules/@gadget-client/shopappchat/dist-esm/connection/exchanges/liveQueryExchange.js
...
var getLiveDirectiveNode = (input) => {
  ...
  return (_a = input.directives) == null ? void 0 : _a.find((d3) => d3.name.value === "live");
};
var isLiveQueryOperationDefinitionNode = (input) => {
  return !!getLiveDirectiveNode(input);
};

// node_modules/@gadget-client/shopappchat/dist-esm/connection/exchanges/operationNameExchange.js
...
// node_modules/@gadget-client/shopappchat/dist-esm/connection/exchanges/urlParamExchange.js
...
// node_modules/@gadget-client/shopappchat/dist-esm/connection/GadgetTransaction.js
...
// node_modules/@gadget-client/shopappchat/dist-esm/connection/InMemoryStorage.js
...
// node_modules/@gadget-client/shopappchat/dist-esm/connection/GadgetConnection.js
var GadgetGraphQLCloseCode = ((GadgetGraphQLCloseCode2) => {
...
var GadgetConnection = class {
  constructor(options) {
    ...
    this.websocketImplementation = options.websocketImplementation ?? (globalThis == null ? void 0 : globalThis.WebSocket) ?? browser_default;
        ...
        forwardSubscription: (request) => {
          return {
            subscribe: (sink) => {
              ...
              const loadAndSubscribe = import("./graphql-live-query-utils-M6QZG2BC.js").then(({ applyAsyncIterableIteratorToSink, applyLiveQueryJSONDiffPatch, makeAsyncIterableIteratorFromSink }) => {
                const input = { ...request, query: request.query || "" };
...
// node_modules/@gadget-client/shopappchat/dist-esm/connection/GadgetRecordList.js
...
// node_modules/@gadget-client/shopappchat/dist-esm/connection/InternalModelManager.js
...
var internalBulkCreateMutation = (apiIdentifier, pluralApiIdentifier, namespace, records) => {
...
// node_modules/@gadget-client/shopappchat/dist-esm/connection/operationRunners.js
...
var findAllRunner = async (modelManager, operation, defaultSelection, modelApiIdentifier8, options, namespace) => {
...
var iterateAllRunner = (modelManager, operation, defaultSelection, modelApiIdentifier8, options, namespace) => {
  const { last: _last, before: _before, live: _live, ...cleanOptions } = options ?? {};
  const pageSize = cleanOptions.first ?? 250;
  return {
    [Symbol.asyncIterator]() {
...
var actionRunner = async (modelManager, operation, defaultSelection, modelApiIdentifier8, modelSelectionField, isBulkAction, variables, options, namespace, hasReturnType) => {
...
// node_modules/@gadget-client/shopappchat/dist-esm/builder.js
...
var processViewResult = (result, dataPath, paused) => {
...
// node_modules/@gadget-client/shopappchat/dist-esm/models/User.js
var DefaultUserSelection = {
  __typename: true,
  id: true,
  createdAt: true,
  email: true,
...
var modelApiIdentifier = "user";
var pluralModelApiIdentifier = "users";
var operations = [
  {
    type: "findOne",
...
var UserManager = buildModelManager(
  modelApiIdentifier,
...
// node_modules/@gadget-client/shopappchat/dist-esm/models/Conversation.js
var DefaultConversationSelection = {
  __typename: true,
  id: true,
  country: true,
  createdAt: true,
...
var modelApiIdentifier2 = "conversation";
var pluralModelApiIdentifier2 = "conversations";
var operations2 = [
  {
    type: "findOne",
    operationName: modelApiIdentifier2,
  ...
  {
    type: "findMany",
    operationName: pluralModelApiIdentifier2,
    modelApiIdentifier: modelApiIdentifier2,
    defaultSelection: DefaultConversationSelection,
    namespace: null
  },
  ...
  },
  {
    ...
    modelApiIdentifier: modelApiIdentifier2,
    operatesWithRecordIdentity: false,
    modelSelectionField: modelApiIdentifier2,
    isBulk: false,
    isDeleter: false,
    variables: {
  ...
  },
  {
    ...
    modelApiIdentifier: modelApiIdentifier2,
    modelSelectionField: pluralModelApiIdentifier2,
    namespace: null,
    variables: {
...
var ConversationManager = buildModelManager(
  modelApiIdentifier2,
...
// node_modules/@gadget-client/shopappchat/dist-esm/models/Message.js
var DefaultMessageSelection = {
  __typename: true,
  id: true,
  content: true,
  conversationId: true,
...
var modelApiIdentifier3 = "message";
var pluralModelApiIdentifier3 = "messages";
var operations3 = [
  {
    type: "findOne",
...
var MessageManager = buildModelManager(
  modelApiIdentifier3,
...
// node_modules/@gadget-client/shopappchat/dist-esm/models/Session.js
...
var modelApiIdentifier4 = "session";
var pluralModelApiIdentifier4 = "sessions";
var operations4 = [
  {
    type: "findOne",
...
// node_modules/@gadget-client/shopappchat/dist-esm/models/CurrentSession.js
...
var modelApiIdentifier5 = "session";
var pluralModelApiIdentifier5 = "sessions";
var operations5 = [
  {
    type: "get",
...
// node_modules/@gadget-client/shopappchat/dist-esm/models/Organization.js
var DefaultOrganizationSelection = {
  __typename: true,
  id: true,
  createdAt: true,
  name: true,
...
var modelApiIdentifier6 = "organization";
var pluralModelApiIdentifier6 = "organizations";
var operations6 = [
  {
    type: "findOne",
...
var OrganizationManager = buildModelManager(
  modelApiIdentifier6,
...
// node_modules/@gadget-client/shopappchat/dist-esm/models/Customer.js
...
var modelApiIdentifier7 = "customer";
var pluralModelApiIdentifier7 = "customers";
var operations7 = [
  {
    type: "findOne",
...
// node_modules/@gadget-client/shopappchat/dist-esm/Client.js
...
var ShopappchatClient = class _ShopappchatClient {
  constructor(options) {
    var _a, _b;
...
var Client2 = ShopappchatClient;

// node_modules/@gadget-client/shopappchat/dist-esm/types.js
var GadgetFieldType = ((GadgetFieldType2) => {
...
var BackgroundActionPriority = ((BackgroundActionPriority2) => {
...
var BackgroundActionStatus = ((BackgroundActionStatus2) => {
  BackgroundActionStatus2[BackgroundActionStatus2["scheduled"] = 0] = "scheduled";
  BackgroundActionStatus2[BackgroundActionStatus2["waiting"] = 1] = "waiting";
  BackgroundActionStatus2[BackgroundActionStatus2["retrying"] = 2] = "retrying";
  BackgroundActionStatus2[BackgroundActionStatus2["running"] = 3] = "running";
  BackgroundActionStatus2[BackgroundActionStatus2["completed"] = 4] = "completed";
  BackgroundActionStatus2[BackgroundActionStatus2["failed"] = 5] = "failed";
  BackgroundActionStatus2[BackgroundActionStatus2["cancelled"] = 6] = "cancelled";
  return BackgroundActionStatus2;
})(BackgroundActionStatus || {});
var BackgroundActionOutcome = ((BackgroundActionOutcome2) => {
...
//# sourceMappingURL=@gadget-client_shopappchat.js.map
